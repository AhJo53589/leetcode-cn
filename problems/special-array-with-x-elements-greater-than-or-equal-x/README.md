# `（简单）` [1608.special-array-with-x-elements-greater-than-or-equal-x 特殊数组的特征值](https://leetcode-cn.com/problems/special-array-with-x-elements-greater-than-or-equal-x/)
