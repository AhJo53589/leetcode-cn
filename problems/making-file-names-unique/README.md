# `（中等）` [1487.making-file-names-unique 保证文件名唯一](https://leetcode-cn.com/problems/making-file-names-unique/)
...
[发布的题解](https://leetcode-cn.com/problems/making-file-names-unique/solution/making-file-names-unique-by-ikaruga/)
