# `（困难）` [1235.maximum-profit-in-job-scheduling 规划兼职工作](https://leetcode-cn.com/problems/maximum-profit-in-job-scheduling/)

[contest](https://leetcode-cn.com/contest/weekly-contest-159/problems/maximum-profit-in-job-scheduling/)
