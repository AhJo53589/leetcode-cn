# `（困难）` [5675.closest-subsequence-sum 最接近目标值的子序列和](https://leetcode-cn.com/problems/closest-subsequence-sum/)

[contest](https://leetcode-cn.com/contest/weekly-contest-227/problems/closest-subsequence-sum/)
