# `（中等）` [1626.best-team-with-no-conflicts 无矛盾的最佳球队](https://leetcode-cn.com/problems/best-team-with-no-conflicts/)

[contest](https://leetcode-cn.com/contest/weekly-contest-211/problems/best-team-with-no-conflicts/)
