# `（中等）` [1223.dice-roll-simulation 掷骰子模拟](https://leetcode-cn.com/problems/dice-roll-simulation/)

[contest](https://leetcode-cn.com/contest/weekly-contest-158/problems/dice-roll-simulation/)
