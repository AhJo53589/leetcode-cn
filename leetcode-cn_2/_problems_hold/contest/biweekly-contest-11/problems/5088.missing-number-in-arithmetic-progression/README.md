# `（简单）`  [5088.missing-number-in-arithmetic-progression 等差数列中缺失的数字](https://leetcode-cn.com/contest/biweekly-contest-11/problems/missing-number-in-arithmetic-progression/)
